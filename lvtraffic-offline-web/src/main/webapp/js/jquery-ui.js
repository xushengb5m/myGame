...
$.extend(Datepicker.prototype, {
	...
	_selectDay: function(id, month, year, td) {
		...
		if(inst.currentDay == "今天"){
			var date = new Date();
			inst.selectedDay = inst.currentDay = date.getDate();
			console.log(inst.currentDay);
		}
		if(inst.currentDay == "明天"){
			var date = new Date();
			inst.selectedDay = inst.currentDay = date.getDate()+1;
		}
		if(inst.currentDay == "后天"){
			var date = new Date();
			inst.selectedDay = inst.currentDay = date.getDate()+2;
